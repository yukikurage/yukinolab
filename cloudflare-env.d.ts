/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 143b166ed3cadea40d9fa36ade598ae4)
// Runtime types generated with workerd@1.20251001.0 2024-12-30 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		DISCORD_SPAM_WEBHOOK_URL: string;
		ALLOWED_EMAILS: string;
		DEVELOPMENT_ADMIN_EMAIL: string;
		NEXTJS_ENV: string;
		NEXT_INC_CACHE_R2_BUCKET: R2Bucket;
		UPLOADS_BUCKET: R2Bucket;
		WORKER_SELF_REFERENCE: Fetcher /* yukinolabo */;
	}
}
