    ...
    <WithCrossEffect>
      {({ fireEffect }) => (
              ...
              >
                <div className="flex items-center h-full">
                  <button
                    ...
                    className="font-title text-lg font-semibold transition-colors hover:text-primary-dark cursor-pointer px-4 h-full w-fit"
                  >
                    ABOUT
                  </button>
                  <button
        ...
        ${
          ...
          >
            <nav
              className="container mx-auto px-8 py-8 h-full"
            ...
            >
              <div className="flex flex-col h-full w-fit">
                <button
                  ...
                  className="font-title text-2xl font-semibold transition-colors hover:text-primary-dark cursor-pointer w-full text-left py-2"
                >
                  ABOUT
                </button>
                <button
